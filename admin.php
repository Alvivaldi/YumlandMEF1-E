...
<body class="admin-body">
    ...
    ?>
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 20px; text-align: left; color:black">
                <thead>
                ...
                ?>
                    <tr style="border-bottom: 1px solid #eef2f5;" id="user-row-<?php echo $u['id']; ?>">
                        ...
                        <td style="padding: 12px; text-transform: uppercase; font-size: 0.85rem; font-weight: bold;">
                            <?php echo htmlspecialchars($u['role'] ?? 'client'); ?></td>
                        ...
                        <td style="padding: 12px;">
                            <button class="btn-toggle-block" data-id="<?php echo $u['id']; ?>"
                            ...
                            if (badgeContainer) {
                                if (nouveauStatut === 'bloqué') {
                                    badgeContainer.innerHTML =
                                        `<span style="padding: 4px 8px; border-radius: 4px; font-weight: bold; font-size: 0.85rem; background-color: #e63946; color: white;">bloqué</span>`;
                                    this.textContent = '🔓 Débloquer';
                                    this.style.backgroundColor = '#2a9d8f';
                                    this.setAttribute('data-statut', 'bloqué');
                                } else {
                                    badgeContainer.innerHTML =
                                        `<span style="padding: 4px 8px; border-radius: 4px; font-weight: bold; font-size: 0.85rem; background-color: #2a9d8f; color: white;">actif</span>`;
