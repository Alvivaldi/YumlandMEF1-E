...
<body>
  ...
  <div class="livraison-container">
    ...
    <div class="info-livraison">
      <div class="field">
        <span>Adresse :</span>
        <span>650 route de la fromonière, Soings-en-Solognes</span>
      </div>
      <div class="field">
      ...
      <div class="field">
        ...
        <span>Caresser le chat et entrez</span>
      </div>
      <div class="field">
        <span>Téléphone :</span>
        <span><a href="tel:+3301010101">01 01 01 01 01</a></span>
      </div>
    </div>

    <div class="actions">
      <a href="https://www.google.com/maps/search/?api=1&query=650+Route+de+la+Fromonière+Soings-en-Sologne"
        target="_blank" class="btn nav-btn">Ouvrir dans Maps</a>
      <a href="https://waze.com/ul?ll=48.8566,2.3522&navigate=yes" target="_blank" class="btn nav-btn">Ouvrir dans
        Waze</a>

      <button class="btn complete-btn" disabled>Livraison terminée</button>
    </div>
  </div>
</body>
